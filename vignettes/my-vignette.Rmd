...
### Examples of the Law of Large Numbers function
This function will help to determine if there is a Law of Large Numbers. The function also plots the mean.  
```{r, echo=FALSE, fig.width=3, fig.height=3, fig.align='center'}
x <- replicate(10, simAR1(0, 5000, 0.8, rnorm, 5000))
LLN(x)
```

### Examples of the Central Limit Theorm function
This function helps determine if $$\frac{\sum_{i=1}^n Y_i}{\sqrt{n}}$$ converges in distribution as $n\to\infty$ to a normal distribution. 
```{r}
